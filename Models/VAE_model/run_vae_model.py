def get_vae_latent_vectors(latent_vector_length):
    import tensorflow
    ...
    x_all = pd.read_csv(upper_directory + '\\Meshes\\all_meshes.csv')
    x_target = pd.read_csv(upper_directory + '\\Meshes\\target_meshes.csv')
